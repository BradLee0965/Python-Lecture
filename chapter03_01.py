...
complex : 복소수
bool : 불린
str : 문자열(시퀀스) 시퀀스는 반복을 처리할 수 있고 순서가 있는 것.
list : 리스트(시퀀스)
tuple : 튜플(시퀀스)
set : 집합
dict : 사전 , 사전을 찾을땐 색인에서 단어를 보고 단어에 대한 내용을 확인한다.
'''
...
# 수치 연산 함수
print(abs(-7))
x, y = divmod(100, 8) #divmod --> 몫과 나머지 구함. 
print(x, y)
print(pow(5, 3))
...
#floor
print(math.floor(5.1)) # x 이하의 수 중에서 가장 큰 정수
